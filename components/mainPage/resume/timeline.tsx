            ...
            <div className={styles.uwu}>
                ...
                <ol className={styles.timelinelist}>
                    <li className={styles.timelineitem}>
                        <h4 className={`h4 ${styles.timelineitemtitle}`}>Self-Educated develper</h4>
            ...
            <div className={styles.uwu}>
                ...
                <ol className={styles.timelinelist}>
                    <li className={styles.timelineitem}>
                        ...
                        <span>2019 — Present</span>
                        <p className={styles.timelinetext}>I don't have any profecional experience in the developing industry.</p>
                    </li>
                    <li className={styles.timelineitem}>
