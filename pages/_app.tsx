...
function App({ Component, pageProps }: AppProps) {
    ...
    const blogNotDevDescription = "While I know a bit of coding (Java, JavaScript, Python, etc.), I don't consider myself a programmer. Coding for me is more of a creative hobby—like DIY crafting with digital tools—used to add fun and cuteness to my projects, not a career goal. I'm not looking to work in tech, just enjoying coding as a playful way to solve small problems and explore new ideas without pressure.";
